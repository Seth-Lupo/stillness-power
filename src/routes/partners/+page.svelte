...
<svelte:head>
  <title>{partners.title} - Stillness Power®</title>
  <meta name="description" content="Partner with Stillness Power® to deliver holistic wellness programs to your organization or community." />
</svelte:head>
