// Cleaned content extracted from the original site (excluding user comments)

export const siteContent = {
	homepage: {
		title: 'Stillness Power® Path – Breathe to have Bliss- Prayerful Practice!™',
		tagline: 'Breathe to have Bliss—Prayerful Practice!™',
		mission: {
			title: 'Our Mission',
			description:
		...
		teachers: {
			title: 'Our Teachers',
			description:
				'Our founder/creator of Stillness Power® is the master coach. Please visit OM STUDIO CENTRAL for more info.',
			founder:
				'Created / Founded by Sanjyot Chatwani known Sanjyot Lupo. Stillness Power® sessions are offered at a well loved and respected yoga studio known by the name OM Studio Central based in North Chelmsford, MA.'
		},
		contact: {
		...
		classTypes: [
			{
				name: 'STILLNESS POWER® TRADITIONAL',
				description: 'Classic approach to meditative wellness'
			},
			{
				name: 'STILLNESS POWER® AERIAL',
				description: 'Elevated practice combining aerial techniques'
			},
			{
				name: 'STILLNESS POWER® VIRTUAL 2 WAY',
	...
	partners: {
		title: 'Partners',
		subtitle:
			'Partner with us to deliver Stillness Power. Look for our Luminous Logo where our Programs are offered!',
		nonprofit: {
			title: 'NON PROFIT Partnership',
			description:
				'We also partner with NON PROFIT organizations to deliver our "Whole Being fitness" programs tailored to yours members and non members, including onetime seminar/workshop and sustainable longterm programs.'
		},
		contact: {
	...
	blog: {
		...
		description:
			"Sacred insights and practical guidance from Sanjyot's years of teaching meditation, breathwork, and the transformative path of Stillness Power® practice"
	}
};
